...
public class TransCollision extends TransInfo {
	...
	public void transform(MethodNode mnode){
		...
		//this.collidingBoundingBoxes.clear(); の後に com/mito/exobj/asm/BraceCoreHooks のstaticなメソッド getCollisionHook(this, p_72945_2_, this.collidingBoundingBoxes, p_72945_1_)
		...
		overrideList
				.add(new MethodInsnNode(INVOKESTATIC, "com/mito/exobj/asm/BraceCoreHooks", "getCollisionHook", "(Lnet/minecraft/world/World;Lnet/minecraft/util/AxisAlignedBB;Ljava/util/List;Lnet/minecraft/entity/Entity;)V", false));
