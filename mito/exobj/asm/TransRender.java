...
public class TransRender extends TransInfo {
	...
	public void transform(MethodNode mnode){
		...
		//com.mito.exobj.BraceBase.BB_RenderHandler のstaticなメソッド onRenderEntities(p_147589_1_, p_147589_2_, p_147589_3_)
		...
		overrideList
				.add(new MethodInsnNode(INVOKESTATIC, "com/mito/exobj/BraceBase/BB_RenderHandler", "onRenderEntities", "(Lnet/minecraft/entity/EntityLivingBase;Lnet/minecraft/client/renderer/culling/ICamera;F)V", false));
